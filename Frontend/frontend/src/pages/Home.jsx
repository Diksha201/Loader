...
import RidePopUp from '../components/RidePopUp'; // This will render the map
...
const Home = () => {
    ...
    const [fare, setFare] = useState({minitruck:1200, truck:2500, tractor: 1500})
  ...
  { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` } }
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <h1 className="absolute left-5 top-5 w-16 text-3xl font-bold text-black  ">
  Loader
</h1>
